...
setInterval(() => {
    ...
    ++main.api
    vk.api.status.set({text: `🔧 ${config.codename} | 💻 UPTIME: ${main.uptime.days} дней ${main.uptime.hours} часов ${main.uptime.min} минут | 📤 Сообщений отправлено: ${main.out} | ✉ Сообщений принято: ${main.in} | 🔧 Создатель Лелуш Ви-Британия`});
}, 60000)
setInterval(() => {
